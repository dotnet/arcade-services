...
param http80listener string
param http443listener string
param httpRedirection string
param http80rule string
param http443rule string
    ...
    redirectConfigurations: [
      {
        ...
        properties: {
          ...
          targetListener: {
            id: resourceId('Microsoft.Network/applicationGateways/httpListeners', appGwName, http443listener)
          }
          includePath: true
    ...
    requestRoutingRules: [
      {
        ...
        properties: {
          priority: 1
          httpListener: {
            id: resourceId('Microsoft.Network/applicationGateways/httpListeners', appGwName, http80listener)
          }
          redirectConfiguration: {
            id: resourceId('Microsoft.Network/applicationGateways/redirectConfigurations', appGwName, httpRedirection)
          }
        }
      }
      {
