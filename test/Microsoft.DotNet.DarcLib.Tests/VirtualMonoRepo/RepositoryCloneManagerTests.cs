...
public class RepositoryCloneManagerTests
{
    ...
    public async Task RepoIsClonedOnceTest()
    {
        ...
        _repoCloner.Verify(x => x.CloneAsync(RepoUri, _clonePath, null), Times.Once);
    ...
    public async Task CloneIsReusedTest()
    {
        ...
        _repoCloner.Verify(x => x.CloneAsync(RepoUri, _clonePath, null), Times.Never);
        _localGitRepo.Verify(x => x.CheckoutNativeAsync(_clonePath, Ref), Times.Once);
    ...
    public async Task MultipleRemotesAreConfiguredTest()
    {
        ...
        _repoCloner.Verify(x => x.CloneAsync(mapping.DefaultRemote, clonePath, null), Times.Once);
        ...
        path.Should().Be(clonePath);
        _repoCloner.Verify(x => x.CloneAsync(mapping.DefaultRemote, clonePath, null), Times.Never);
        ...
        path.Should().Be(clonePath);
        _repoCloner.Verify(x => x.CloneAsync(RepoUri, clonePath, null), Times.Never);
