    ...
    public class KnownIssuesProviderTests
    {
        private sealed class TestData : IDisposable, IAsyncDisposable
        {
            ...
            public class Builder
            {
                ...
                private readonly Mock<ITableClientFactory> _tableClientMock = new Mock<ITableClientFactory>();
                ...
                public TestData Build()
                {
                    ...
                    var tableClient = new TableClient(new Uri($"https://example.com"), tableName: "table", new TableSharedKeyCredential("someaccount", string.Empty));
                    _tableClientMock.Setup(m => m.GetTableClient(It.IsAny<string>(), It.IsAny<string>())).Returns(tableClient);
                    ...
                    ServiceProvider services = collection
                        ...
                        .AddSingleton(_tableClientMock.Object)
        ...
        public void ReadSavedRecords()
        {
            ...
            List<KnownIssueMatch> savedMatches = testData.KnownIssuesProvider.GetKnownIssueFromDataReader(readerMock.Object);
