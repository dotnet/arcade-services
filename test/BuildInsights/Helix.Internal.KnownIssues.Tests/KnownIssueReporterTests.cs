...
{
    public partial class KnownIssueReporterTests
    {
        ...
        public static class TestSetup
        {
            ...
            public static Func<IServiceProvider, KnownIssueReporter> Processor(IServiceCollection collection)
            {
                collection.AddSingleton<KnownIssueReporter>();

                return s => s.GetRequiredService<KnownIssueReporter>();
            }
        ...
        public async Task WriteReportFirstTimeTest(string issueBody)
        {
            await using TestData testData = await TestData
                ...
                .BuildAsync();
            await testData.Processor.ExecuteKnownIssueReporter();
        ...
        {
            string link = KnownIssueReporter.GetBuildLink(MockKnownIssueMatch(1234, TestSetup.DefaultTime.DateTime));
            link.Should().Be("1234");
        }
        ...
        public void GetBuildLinkWithProject()
        {
            ...
            string link = KnownIssueReporter.GetBuildLink(mockMatch);
