...
namespace Microsoft.Internal.Helix.BuildFailureAnalysis.Tests
{
    ...
    public class HelpersTests
    {
        ...
        private class TestData<THelper> : IDisposable, IAsyncDisposable
        {
            ...
            public class Builder
            {
                public TestData<THelper> Build()
                {
                    ...
                    collection.AddUserSentiment(o => o.Host = SentimentHost);
        ...
        {
            using var testData = TestData<HandlebarHelpers.MarkdownLinkHelper>.BuildDefault();
        ...
        {
            using var testData = TestData<HandlebarHelpers.HtmlLinkHelper>.BuildDefault();
        ...
        {
            using var testData = TestData<HandlebarHelpers.TruncateHelper>.BuildDefault();
        ...
        {
            using var testData = TestData<HandlebarHelpers.RenderKnownLinks>.BuildDefault();
        ...
        {
            using var testData = TestData<HandlebarHelpers.SplitMessageIntoCollapsibleSectionsByLength>.BuildDefault();
        ...
        public void FailingConfigurationBlockWithNoFailingConfigurationsTest()
        {
            ...
            using var testData = TestData<HandlebarHelpers.FailingConfigurationBlock>.BuildDefault();
