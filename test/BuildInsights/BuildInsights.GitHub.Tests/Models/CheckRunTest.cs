...
namespace BuildInsights.GitHub.Tests.Models
{
    [TestFixture]
    public class CheckRunTest
    {
        ...
        [TestCase(CheckStatus.Completed, BuildInsights.GitHub.Models.CheckStatus.Completed)]
        [TestCase(CheckStatus.Queued, BuildInsights.GitHub.Models.CheckStatus.Queued)]
        [TestCase(CheckStatus.InProgress, BuildInsights.GitHub.Models.CheckStatus.InProgress)]
        public void CheckRunStatus(CheckStatus status, BuildInsights.GitHub.Models.CheckStatus expectedStatus)
        {
