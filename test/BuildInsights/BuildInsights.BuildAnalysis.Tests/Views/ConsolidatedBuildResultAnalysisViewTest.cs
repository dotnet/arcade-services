...
public class ConsolidatedBuildResultAnalysisViewTest
{
    ...
    private static BuildResultAnalysis MockBuildResultAnalysis(int buildId, List<TestResult> testResults,
    ...
    private static TestResult MockTestResult(bool isKnownIssue = false)
    {
    ...
    private static TestResult MockTestResultFlaky()
    {
        return new TestResult(
            new TestCaseResult("", new DateTimeOffset(2021, 5, 28, 11, 0, 0, TimeSpan.Zero),
