...
public partial class TestResultProviderTests
{
    ...
    private static TestCaseResult MockTestCaseResult(string name, string comment, string errorMessage = "")
    {
    ...
    private static Issue MockGithubIssue(string body)
    {
    ...
    private static TestRunSummary MockTestRunSummary()
    {
