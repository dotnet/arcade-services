...
internal class ScenarioTests_Dependencies : ScenarioTestBase
{
    ...
    public async Task ArcadeDependencies_EndToEnd()
    {
        ...
        List<AssetData> source1Assets = GetAssetData("Foo", "1.1.0", "Bar", "2.1.0");
        List<AssetData> source2Assets = GetAssetData("Pizza", "3.1.0", "Hamburger", "4.1.0");
        List<AssetData> targetAssets = GetAssetData("Source1", "3.1.0", "Source2", "4.1.0");
