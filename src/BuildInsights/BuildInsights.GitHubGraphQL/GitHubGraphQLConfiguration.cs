...
{
    public static IServiceCollection AddGitHubGraphQL(this IServiceCollection services, IConfiguration gitHubGraphQLOptions)
    {
        ...
        services.Configure<GitHubGraphQLOptions>(gitHubGraphQLOptions);
