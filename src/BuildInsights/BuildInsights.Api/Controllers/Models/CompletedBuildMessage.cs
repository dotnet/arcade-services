...
{
    public const string MessageEventType = "build.complete";
...
public class MockCompletedBuildMessage : CompletedBuildMessage
{
    public new const string MessageEventType = "mocked.build.complete";
