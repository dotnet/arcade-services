...
public static class MergePoliciesPopUpHelpers
{
    ...
    public static List<MergePolicy> ConvertMergePolicies(List<MergePolicyYamlData> mergePolicies)
    {
    ...
    public static List<MergePolicyYamlData> ConvertMergePolicies(IEnumerable<MergePolicy> value)
    {
        return value.Select(
                d => new MergePolicyYamlData
                {
                    Name = d.Name,
