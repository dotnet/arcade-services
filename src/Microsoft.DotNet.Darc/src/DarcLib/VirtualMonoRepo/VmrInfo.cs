...
public class VmrInfo : IVmrInfo
{
    ...
    public const string ThirdPartyNoticesFileName = "eng/bootstrap/THIRD-PARTY-NOTICES.txt";
    public const string ThirdPartyNoticesTemplatePath = "THIRD-PARTY-NOTICES.template.txt";
