...
public static class GitRepoUtils
{
    ...
    private static readonly Regex GitHubPullRequestNumberExtractionRegex = new(".+\\(#(\\d+)\\)$");
    ...
    private static readonly Regex AlternativeGitHubPullRequestNumberExtractionRegex = new("^Merge pull request #(\\d+)");
    ...
    private static readonly Regex AzDoPullRequestNumberExtractionRegex = new("^Merged PR (\\d+):");
