...
{
    Task<IWorkBranch> CreateWorkBranch(string repoDir, string branchName);
}
...
public class WorkBranchFactory : IWorkBranchFactory
{
    ...
    public async Task<IWorkBranch> CreateWorkBranch(string repoDir, string branchName)
    {
        ...
        await _localGitClient.CheckoutNative(repoDir, branchName, createBranch: true, overwriteExistingBranch: true);
