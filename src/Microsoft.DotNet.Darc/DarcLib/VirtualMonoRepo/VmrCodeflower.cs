        ...
        catch (PatchApplicationFailedException e)
        {
            ...
            else
            {
                ...
                if (headBranchExisted)
                {
                    ...
                    throw new ConflictInPrBranchException(e.Result.StandardError, codeflowOptions.TargetBranch, codeflowOptions.Mapping.Name, isForwardFlow: codeflowOptions.CurrentFlow.IsForwardFlow);
                }
