    ...
    : ILocalGitRepo
{
    ...
    public async Task<string> GetMergeBaseAsync(string commitOrBranchA, string commitOrBrancB)
        => await _localGitClient.GetMergeBaseAsync(Path, commitOrBranchA, commitOrBrancB);
