...
public static class DependencyFlowConfiguration
{
    ...
    public static void AddDependencyFlowProcessors(this IServiceCollection services)
    {
        ...
        services.TryAddTransient<IMergePolicyEvaluatorFactory, MergePolicyEvaluatorFactory>();
        ...
        services.TryAddTransient<IPullRequestConflictNotifier, PullRequestConflictNotifier>();
