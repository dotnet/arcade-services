...
internal class SubscriptionsController : v2019_01_16.Controllers.SubscriptionsController
{
    ...
    [ApiRemoved]
    public sealed override Task<IActionResult> UpdateSubscription(Guid id, [FromBody] Maestro.Web.Api.v2018_07_16.Models.SubscriptionUpdate update)
    {
        throw new NotImplementedException();
    }
    ...
    [ApiRemoved]
    public override Task<IActionResult> Create([FromBody, Required] Maestro.Web.Api.v2018_07_16.Models.SubscriptionData subscription)
    {
        throw new NotImplementedException();
    }
