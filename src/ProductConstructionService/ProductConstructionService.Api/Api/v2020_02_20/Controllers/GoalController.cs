...
internal class GoalController : v2019_01_16.Controllers.GoalController
{
    ...
    [ApiRemoved]
    public override Task<IActionResult> Create([FromBody, Required] Maestro.Web.Api.v2019_01_16.Models.Goal.GoalRequestJson goalData, [Required] string channelName, [Required] int definitionId)
    {
