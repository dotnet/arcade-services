...
internal class SubscriptionsController : v2018_07_16.Controllers.SubscriptionsController
{
    ...
    [ValidateModelState]
    public override async Task<IActionResult> UpdateSubscription(Guid id, [FromBody] Maestro.Web.Api.v2018_07_16.Models.SubscriptionUpdate update)
    {
    ...
    [ValidateModelState]
    public override async Task<IActionResult> Create([FromBody, Required] Maestro.Web.Api.v2018_07_16.Models.SubscriptionData subscription)
    {
