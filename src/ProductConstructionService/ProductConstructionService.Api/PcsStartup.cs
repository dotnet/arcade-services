...
internal static class PcsStartup
{
    ...
    /// </summary>
    internal static string LocalCompiledStaticFilesPath => @"D:\repos\arcade-services\artifacts\bin\ProductConstructionService.BarViz\Release\net8.0\browser-wasm\publish\wwwroot";// Path.Combine(Environment.CurrentDirectory, "..", "ProductConstructionService.BarViz", "wwwroot");
