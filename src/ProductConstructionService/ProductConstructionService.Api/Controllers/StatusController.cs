...
[Route("status")]
internal class StatusController(JobScopeManager jobProcessorScopeManager, BuildAssetRegistryContext a, ILogger<StatusController> logger)
    : InternalController
{
    ...
    {
        logger.LogInformation(a.Channels.Count().ToString());
