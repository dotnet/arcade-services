...
public interface IReplicaWorkItemProcessorStateCacheFactory
{
    ...
    /// </summary>
    Task<List<WorkItemProcessorStateCache>> GetAllWorkItemProcessorStateCachesAsync(string revisionName);
}
...
public class ReplicaWorkItemProcessorStateCache : IReplicaWorkItemProcessorStateCacheFactory
{
    ...
    public async Task<List<WorkItemProcessorStateCache>> GetAllWorkItemProcessorStateCachesAsync(string revisionName)
    {
