...
{
    public partial interface IDarcVersion
    {
    ...
    internal partial class DarcVersion : IServiceOperations<ProductConstructionServiceApi>, IDarcVersion
    {
        public DarcVersion(ProductConstructionServiceApi client)
        {
