...
public class MergePolicyEvaluationResults
{
    ...
    public bool Succeeded => Results.Count != 0 && Results.All(r => r.Status is MergePolicyEvaluationStatus.DecisiveSuccess or MergePolicyEvaluationStatus.TransientSuccess);
