...
<<<<<<<< HEAD:src/Maestro/Maestro.Common/GitHubTokenProvider.cs
namespace Maestro.Common;

public class GitHubTokenProvider(Microsoft.DotNet.GitHub.Authentication.IGitHubTokenProvider tokenProvider) : IRemoteTokenProvider
========
...
>>>>>>>> dotnet/main:src/Maestro/Maestro.DataProviders/GitHubTokenProvider.cs
{
