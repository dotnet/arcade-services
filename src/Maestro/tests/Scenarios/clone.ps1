...
try {
    ...
    try { Darc-Command -darcParams @( "clone", "--repo", "$sourceRepoUri", "--version", "$sourceRepoVersion", "--git-dir-folder", "$gitDirFolder", "--ignore-repos", "$reposToIgnore", "--repos-folder", "$reposFolder", "--depth", "2") } catch {}
    ...
    try { Darc-Command -darcParams @( "clone", "--repo", "$sourceRepoUri", "--version", "$sourceRepoVersion", "--git-dir-folder", "$gitDirFolder", "--ignore-repos", "$reposToIgnore", "--repos-folder", "$reposFolder", "--depth", "4", "--include-toolset" ) } catch {}
