...
namespace Maestro.Web.Controllers
{
    ...
    {
        private IRemoteFactory remoteFactory;
        private ILogger<DependenciesController> logger;
        ...
        //public async Task<IActionResult> GetDependencyDetails(string repo, string branch)
        //{
