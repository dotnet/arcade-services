...
public partial class Startup
{
    private void ConfigureApiServices(IServiceCollection services)
    {
        ...
        services.AddSwaggerApiVersioning(
            ...
            {
                info.Description =
                    "The Web API enabling access to the Maestro++ service that supports the [.NET Core Dependency Flow infrastructure](https://github.com/dotnet/arcade/blob/main/Documentation/DependenciesFlowPlan.md).";
