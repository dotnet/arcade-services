...
public static class AuthenticationConfiguration
{
    ...
    public static void ConfigureAuthServices(this IServiceCollection services, bool isDevelopment, GitHubAuthenticationOptions gitHubOptions, string authenticationSchemeRequestPath)
    {
        services.AddIdentity<ApplicationUser, IdentityRole<int>>(
                options => { options.Lockout.AllowedForNewUsers = false; })
            .AddEntityFrameworkStores<BuildAssetRegistryContext>();
        ...
        AuthenticationBuilder authBuilder = services.AddAuthentication(options =>
        {
            ...
            .AddPersonalAccessToken<ApplicationUser>(
                ...
                }).AddGitHubOAuth(gitHubOptions, GitHubScheme);
